...
def main():
    ...
    if RESULTS_JSON.exists():
        ...
        # rebase it to what's actually left to run so the progress percentage
        # and ETA below (which only count newly-completed tasks this run)
        # stay meaningful instead of asymptoting below 100%.
